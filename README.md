...
**已内置 20 套规则**（覆盖安全 / AI / 数据 / 研发 / 解决方案，按岗位名自动路由，大小写无关）：

| 方向 | 岗位规则 |
| --- | --- |
| 安全 | 网络安全渗透测试工程师 · 安全开发工程师 · AI安全工程师 · 安全运营工程师 · 安全研究员 |
| AI / 算法 | 大模型应用开发工程师 · AI全栈工程师 · 算法工程师 · NLP工程师 · 计算机视觉工程师 · MLOps工程师 |
| 解决方案 / 项目 | FDE解决方案架构师 · AI项目经理 · 工作流工程师 |
| 数据 | 数据科学家 · 数据分析师 |
| 产品 | AI产品经理 · 医疗AI产品经理 |
| 通用 | 后端开发工程师 · 通用（兜底） |

> `② JD 管理` 页支持**一键选用内置示例 JD**（安全/AI/全栈/FDE/项目/工作流），选中即填入、点解析即可。
