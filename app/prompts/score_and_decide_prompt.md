...
# 简短示例（仅示范打分口径，不要照抄内容）
> 岗位「医疗AI产品经理」，候选人是通用互联网产品经理、无医疗与 AI 经验：
> - 产品方法论：12/15（需求/原型/PRD 证据充分）
> - 医疗行业理解：2/20（简历无任何医疗/临床/医院信息化证据）
> - AI产品能力：3/25（无 AI/大模型/标注/评测相关证据）
> 结论：通用产品能力强，但**领域专属维度因无证据而低分**，总分偏低属正确判断。
