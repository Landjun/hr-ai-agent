...
SKILL_KEYWORDS = [
    ...
    # 网络安全 / 渗透测试
    "渗透测试", "渗透", "漏洞", "漏洞挖掘", "owasp", "sql注入", "xss", "csrf", "ssrf",
    "提权", "内网渗透", "横向移动", "免杀", "getshell", "红队", "蓝队", "应急响应",
    "等保", "等级保护", "iso27001", "waf", "ids", "ips", "抓包", "burpsuite", "burp",
    "nmap", "metasploit", "msf", "cobalt strike", "kali", "sqlmap", "逆向", "二进制",
    "pwn", "ctf", "web安全", "应用安全", "代码审计", "安全加固", "soc", "态势感知",
    "威胁情报", "数据安全", "隐私保护", "src", "众测", "0day", "cve", "poc", "exp",
    "oscp", "cissp", "cisp", "等保测评", "渗透报告", "安全运营", "安全研究",
    # AI 安全
    "对抗样本", "对抗攻击", "模型安全", "越狱", "jailbreak", "prompt注入", "提示词注入",
    "数据投毒", "投毒", "模型水印", "大模型安全", "ai安全", "内容安全", "红队测试",
    # AI / 大模型扩展
    "多模态", "aigc", "扩散模型", "diffusion", "stable diffusion", "强化学习", "rlhf",
    "sft", "lora", "推理优化", "量化", "蒸馏", "向量数据库", "milvus", "faiss",
    "llamaindex", "推荐系统", "召回", "排序", "triton", "onnx", "vllm", "deepspeed",
    "mlops", "数据科学", "数据工程", "特征工程", "ab实验", "数据科学家",
    # 通用研发
    "后端", "前端", "测试", "自动化测试", "selenium", "运维", "devops", "sre",
    "高并发", "分布式", "架构设计", "中间件", "消息队列",
]
...
_DIM_KEYWORDS = {
    ...
    "跨部门协作与推动": ["跨部门", "协作", "推动", "落地", "医生", "研发", "运营",
                 "项目管理", "敏捷", "scrum", "对接"],
    # —— 算法工程师 ——
    "算法基础与建模": ["机器学习", "深度学习", "pytorch", "tensorflow", "transformer",
                "cv", "计算机视觉", "nlp", "建模", "特征工程", "算法", "模型"],
    "工程与落地能力": ["python", "c++", "分布式", "部署", "上线", "工程化", "docker",
                "k8s", "kubernetes", "性能优化", "微服务", "linux"],
    "大模型与前沿技术": ["大模型", "llm", "rag", "微调", "finetune", "agent", "智能体",
                 "向量", "embedding", "知识库", "prompt"],
    "项目与成果": ["项目", "论文", "比赛", "竞赛", "上线", "部署", "开源", "github",
              "kaggle", "%", "提升", "准确率"],
    "数据处理能力": ["数据清洗", "pandas", "spark", "hadoop", "数仓", "etl",
              "数据分析", "sql", "特征工程"],
    # —— 网络安全 / 渗透测试 ——
    "安全攻防实战": ["渗透测试", "渗透", "红队", "内网渗透", "横向移动", "提权", "免杀",
              "getshell", "实战", "攻防", "演练", "metasploit", "cobalt strike", "kali"],
    "安全攻防基础": ["渗透", "漏洞", "web安全", "应用安全", "抓包", "burpsuite", "nmap",
              "owasp", "sql注入", "xss"],
    "漏洞挖掘与利用": ["漏洞", "漏洞挖掘", "0day", "cve", "poc", "exp", "src", "众测",
                "代码审计", "逆向", "pwn", "二进制"],
    "逆向与二进制": ["逆向", "二进制", "pwn", "ida", "ollydbg", "汇编", "脱壳", "调试"],
    "安全工具与编程": ["python", "go", "burpsuite", "nmap", "metasploit", "sqlmap",
                "cobalt strike", "kali", "脚本", "自动化", "编程", "工具开发"],
    "安全监测与响应": ["soc", "态势感知", "应急响应", "日志", "监测", "告警", "siem",
                "入侵检测", "ids", "ips", "waf", "蓝队"],
    "威胁情报与分析": ["威胁情报", "情报", "分析", "溯源", "攻击链", "ioc", "apt"],
    "安全合规与体系": ["等保", "等级保护", "合规", "iso27001", "安全体系", "制度",
                "审计", "风控", "等保测评", "数据安全", "隐私保护"],
    "实战项目与成果": ["项目", "报告", "src", "排名", "挖到", "修复", "上线", "%",
                "ctf", "获奖", "攻防演练"],
    # —— AI 安全 ——
    "ai安全专项": ["对抗样本", "对抗攻击", "模型安全", "越狱", "jailbreak", "prompt注入",
              "提示词注入", "数据投毒", "投毒", "大模型安全", "内容安全", "红队测试",
              "模型水印"],
    "算法与ai基础": ["机器学习", "深度学习", "大模型", "llm", "算法", "模型", "pytorch",
              "nlp", "cv", "对抗"],
    # —— AI 通用 ——
    "算法与建模": ["机器学习", "深度学习", "pytorch", "tensorflow", "transformer",
              "建模", "特征工程", "算法", "模型", "强化学习"],
    "视觉专项能力": ["检测", "分割", "识别", "目标检测", "图像分类", "3d", "ocr",
              "yolo", "opencv", "diffusion", "多模态"],
    "行业与业务理解": ["行业", "业务", "场景", "客户", "需求", "落地", "解决方案"],
    "产品与业务理解": ["产品", "业务", "需求", "场景", "用户", "落地", "商业化"],
    "平台与基础设施": ["k8s", "kubernetes", "容器", "docker", "ci/cd", "监控", "推理服务",
                "triton", "vllm", "onnx", "高可用", "平台", "调度"],
    # —— 通用研发 ——
    "编程与数据结构": ["python", "java", "go", "c++", "算法", "数据结构", "编程", "代码"],
    "后端框架与中间件": ["spring", "fastapi", "flask", "django", "redis", "kafka",
                "消息队列", "mysql", "微服务", "中间件"],
    "系统设计与架构": ["架构", "高并发", "分布式", "系统设计", "性能优化", "可扩展", "容灾"],
    "数据库能力": ["mysql", "postgres", "redis", "mongodb", "索引", "sql", "数据库优化"],
    "数据分析与建模": ["数据分析", "建模", "回归", "分类", "聚类", "统计", "ab实验",
                "pandas", "python"],
    "sql与数据处理": ["sql", "hive", "spark", "etl", "数仓", "数据清洗", "pandas"],
    "业务理解与洞察": ["业务", "指标", "转化", "留存", "增长", "洞察", "复盘", "策略"],
    "业务理解与落地": ["业务", "场景", "落地", "指标", "解决方案", "客户"],
    "数据建模与算法": ["建模", "机器学习", "算法", "回归", "分类", "预测", "特征工程"],
    "数据处理与分析": ["数据清洗", "pandas", "sql", "spark", "统计", "数据分析", "可视化"],
    "可视化与汇报": ["可视化", "tableau", "powerbi", "报表", "看板", "汇报", "bi"],
    "工具与工程": ["python", "sql", "git", "工程化", "自动化", "部署"],
    # —— 安全开发 ——
    "安全编码与攻防理解": ["安全编码", "sdl", "漏洞", "攻防", "安全开发", "代码审计",
                  "安全设计", "威胁建模"],
    "研发与工程能力": ["java", "go", "python", "后端", "api", "工程化", "微服务", "框架", "开发"],
    "安全工具与平台建设": ["安全工具", "sast", "dast", "安全平台", "扫描器", "自动化",
                  "工具开发", "平台建设"],
    # —— AI 全栈 ——
    "全栈开发能力": ["前端", "后端", "全栈", "react", "vue", "node", "api", "python",
              "java", "数据库", "工程"],
    "ai应用与大模型": ["大模型", "llm", "rag", "agent", "ai coding", "copilot", "prompt",
              "向量", "ai应用", "智能体", "微调"],
    "业务集成与落地": ["集成", "对接", "业务", "落地", "上线", "系统", "api", "部署", "解决方案"],
    "数据与工具": ["数据", "sql", "数据库", "工具", "清洗", "api"],
    # —— FDE 解决方案架构师 ——
    "客户业务理解与抽象": ["客户", "业务", "梳理", "抽象", "需求", "场景", "调研", "痛点",
                  "解决方案"],
    "解决方案设计能力": ["解决方案", "架构", "方案设计", "技术选型", "设计", "蓝图"],
    "技术落地与交付": ["落地", "交付", "对接", "实现", "上线", "部署", "poc", "实施"],
    "沟通与项目推动": ["沟通", "推动", "协作", "客户", "项目", "跨部门", "汇报"],
    "ai与技术广度": ["ai", "大模型", "数据", "集成", "云", "架构", "广度", "全栈"],
    # —— AI 项目经理 ——
    "ai理解与顶层设计": ["ai", "大模型", "顶层设计", "规划", "方案", "战略", "蓝图", "架构"],
    "项目管理能力": ["项目管理", "计划", "风险", "资源", "交付", "里程碑", "敏捷", "scrum",
              "pmp", "甘特"],
    "ai工作流落地": ["工作流", "自动化", "coze", "dify", "n8n", "流程", "落地", "编排",
              "低代码"],
    "业务理解": ["业务", "场景", "需求", "流程", "指标", "行业"],
    # —— 工作流工程师 ——
    "业务流程梳理能力": ["流程", "梳理", "sop", "拆解", "业务", "调研", "流程图", "标准化"],
    "知识与数据结构设计": ["知识", "知识库", "数据结构", "沉淀", "schema", "字段", "文档",
                  "标准化"],
    "工作流与自动化搭建": ["工作流", "自动化", "coze", "dify", "飞书", "低代码", "n8n",
                  "编排", "rpa"],
    "工具与技术": ["ai", "api", "低代码", "工具", "python", "自动化", "大模型"],
}
    ...
    for d in dimensions:
        ...
        if dim == "必备技能匹配":
            ...
            bonus = [k for k in ["开源", "论文", "专利", "竞赛", "获奖", "github", "博客",
                                 "mba", "证书", "医学背景", "临床背景", "ctf", "oscp",
                                 "cissp", "cisp", "src", "kaggle", "演讲", "专栏"]
                     if k in resume_text]
